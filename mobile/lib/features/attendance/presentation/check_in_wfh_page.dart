  ...
  Future<bool> _showEnableGpsDialog() async {
    ...
    final result = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
          'Untuk melakukan check in WFH, aktifkan layanan lokasi (GPS) pada perangkat Anda agar sistem dapat memverifikasi titik koordinat.',
  ...
  Future<bool> _showPermissionDeniedForeverDialog() async {
    ...
    final result = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
          'Aplikasi membutuhkan izin akses lokasi untuk mencatat presensi WFH. Silakan aktifkan izin lokasi di Pengaturan Aplikasi.',
          style: AppTypography.textTheme.bodyMedium?.copyWith(
            color: AppColors.textSecondary,
            height: 1.4,
          ),
